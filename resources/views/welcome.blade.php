...
<head>
    ...
    <meta name="description"
        content="Leandro Nacimento — Backend Developer. PHP, Laravel, MySQL, Docker, CI/CD, Azure.">
...
<body>
    ...
    <main>
        ...
        {{-- System Vertical Guide --}}
        <div class="system-guide" aria-hidden="true"></div>

        {{-- ── #overview ──────────────────────────────────── --}}
        <section id="overview" class="section section-transition" aria-labelledby="overview-heading">
            <div class="page">
                <div class="overview">
                    ...
                    <div class="overview__left">
                        ...
                        <div class="overview__details">
                            <div class="overview__details-text">
                                ...
                                <a href="#projects" class="overview__cta" aria-label="Ver proyectos">
                                    Ver proyectos
                                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" aria-hidden="true">
                                        <path d="M5 1L5 9M1 5L5 9L9 5" stroke="currentColor" stroke-width="1"
        ...
        {{-- ── #projects ────────────────────────────────────── --}}
        <section id="projects" class="section section-transition" aria-labelledby="projects-heading">
            <div class="page">
                ...
                <div class="projects__grid">
                    ...
                    <article class="project-card">
                        ...
                        <div class="project-card__links">
                            <a href="https://github.com/LeandroNacimento/Ivonne-Showroom" target="_blank"
                                rel="noopener noreferrer" class="project-card__link" aria-label="Ver código en GitHub">
                            ...
                            <a href="https://www.ivonneshowroom.com.ar" target="_blank" rel="noopener noreferrer"
                                class="project-card__link" aria-label="Ver proyecto en producción">
        ...
        {{-- ── #stack ───────────────────────────────────────── --}}
        <section id="stack" class="section section-transition" aria-labelledby="stack-heading">
            <div class="page">
        ...
        {{-- ── #now ─────────────────────────────────────────── --}}
        <section id="now" class="section section-transition" aria-labelledby="now-heading">
            <div class="page">
        ...
        {{-- ── #contact ─────────────────────────────────────── --}}
        <section id="contact" class="section section-transition" aria-labelledby="contact-heading">
            <div class="page">
                ...
                <div class="contact__inner">
                    ...
                    <div class="contact__links">
                        <a href="https://github.com/LeandroNacimento" target="_blank" rel="noopener noreferrer"
                            class="contact__link" aria-label="GitHub de Leandro Nacimento">
                        ...
                        <a href="https://www.linkedin.com/in/nacimento-leandro/" target="_blank"
                            rel="noopener noreferrer" class="contact__link" aria-label="LinkedIn de Leandro Nacimento">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path
